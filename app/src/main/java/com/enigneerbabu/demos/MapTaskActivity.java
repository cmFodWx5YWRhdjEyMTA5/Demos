...
import com.enigneerbabu.demos.others.DirectionsJSONParser;
...
public class MapTaskActivity extends FragmentActivity implements OnMapReadyCallback {

    private static final String TAG = MapTaskActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mapFragment.getMapAsync(MapTaskActivity.this);
            }
        });
